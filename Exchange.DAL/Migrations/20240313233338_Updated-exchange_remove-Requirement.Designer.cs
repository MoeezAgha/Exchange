...
namespace Exchange.DAL.Migrations
{
    ...
    [Migration("20240313233338_Updated-exchange_remove-Requirement")]
    partial class Updatedexchange_removeRequirement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exchange.DAL.Models.ExchangeOffer", b =>
                {
                    ...
                    b.ToTable("ExchangeOffer", "Product");
                });
            ...
            modelBuilder.Entity("Exchange.DAL.Models.Product", b =>
                {
                    ...
                    b.Property<int?>("AcceptedOfferExchangeOfferId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AcceptedOfferExchangeOfferId");
            ...
            modelBuilder.Entity("Exchange.DAL.Models.Product", b =>
                {
                    b.HasOne("Exchange.DAL.Models.ExchangeOffer", "AcceptedOffer")
                        .WithMany()
                        .HasForeignKey("AcceptedOfferExchangeOfferId");
