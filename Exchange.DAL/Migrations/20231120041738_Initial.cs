    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExchangeOffers", x => x.ExchangeOfferId);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExchangeOffers_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                    table.ForeignKey(
                        name: "FK_ExchangeOffers_Products_ProductId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExchangeOffers_ProductId",
                table: "ExchangeOffers",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeOffers_ProductId1",
                table: "ExchangeOffers",
                column: "ProductId1",
                unique: true,
